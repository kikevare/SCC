...
<!-- Full Page Image Header with Vertically Centered Content -->
	...
	<div class="container-login100" style="background-image: url('imgs/fondos/xx.jpg');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form name="fForm" id="fForm" class="login100-form validate-form" method="post" action="index.php" enctype="application/x-www-form-urlencoded">
				<span class="login100-form-title p-b-37">
					SISTEMA CONTROL DE CONFIANZA
				</span>

				<span class="login100-form-subtitle p-b-37">
					Inicio de sesi&oacute;n
				</span>

				<div class="wrap-input100 validate-input m-b-20" data-validate="Ingrese el nombre de usuario">
					<input class="input100" type="text" name="txt1" id="xTxt1" placeholder="Nombre de usuario">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input m-b-25" data-validate = "Ingrese la contrase&ntilde;a">
					<input class="input100" type="password" name="txt2" id="xTxt2" placeholder="Contrase&ntilde;a">
					<span class="focus-input100"></span>
				</div>
...
<!--
      ...
      <div style="width: 100%;">
            <div id="xdvPiePagina" class="styBarraInf" style="margin: auto;">
                  <div style="font-weight: bold; width: 100%; height: 100%; text-align: center; border: 0px solid black;">
<p style="font-size: 0.7rem; padding: 17px 0px 0px 0px;">&copy;Derechos reservados</p>
                  </div>
            </div>
      </div>
...
<!--===============================================================================================-->
	<script src="includes/bootstrap421/js/popper.min.js"></script>
	<script src="includes/bootstrap421/js/bootstrap.min.js"></script>
<!--===============================================================================================-->
	<script src="includes/vendor/select2/select2.min.js?v="<?php echo rand(); ?> ></script>
<!--===============================================================================================-->
