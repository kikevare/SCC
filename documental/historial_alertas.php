...
<body>
   ...
   ?>
      ...
      $dbpass = 'root';
       ...
       $sql = "select nombre, a_paterno, a_materno, id_corporacion, id_tipo_eval, fecha from tbprog_preliminar where xcurp='".$xPersona->CURP."' and asistencia='1' ORDER BY id_prog_preliminar DESC";
       $sql2 = "select id_evaluacion from tbevaluaciones where curp='".$xPersona->CURP."' ORDER BY id_evaluacion DESC";
       $res=mysqli_query($conexion,$sql2); 
       $resultado=mysqli_query($conexion,$sql); 
      ?>
                    <div>
                        <p id="enca"> SELECCIONE UNA EVALUACION PARA MODIFICAR LA ALERTA DE RIESGO.</p>
                    </div>
                    <section class="tab_cont">
                        <section class="tab_enca">
                            ...
                            <div id="ap">
                                <P id="encab"> APELLIDO PATERNO</P>
                            </div>
                            <div id="am">
                                <P id="encab"> APELLIDO MATERNO</P>
                            </div>
                            <div id="cor">
                                <P id="encab"> CORPORACION</P>
                            </div>
                            <div id="ev">
                                <P id="encab"> TIPO EVALUACION</P>
                            </div>
                            <div id="fch">
                                <P id="encab"> FECHA</P>
                            </div>
           ...
           $filas2=mysqli_fetch_assoc($res);
                
           ?>
                        <section class="result">
                            <div id="nom2">
                                <p id="txt"><?php echo $filas['nombre'] ?></p>
                            </div>
                            <div id="ap2">
                                <p id="txt"><?php echo $filas['a_paterno']  ?></p>
                            </div>
                            <div id="am2">
                                <p id="txt"><?php echo $filas['a_materno']  ?></p>
                            </div>

                            <div id="cor2">
                                <p id="txt"><?php
     if ($filas ['id_corporacion']==1) {
       echo "SSPyPC ESTATAL";
     }
     ...
     if ($filas ['id_corporacion']==3) {
       ...
       ?></p>
                            ...
                            <div id="ev2">
                                <p id="txt"><?php if ($filas['id_tipo_eval']==1) {
            echo "NUEVO INGRESO";
        }
        ...
        ?></p>
                            ...
                            <div id="fch2"><a id="edit"
                                    href="historial_alertas_edit.php?id=<?php echo $filas2['id_evaluacion']?>"><img
                                        src="<?php echo $xPath;?>imgs/edit_hist.png" alt="" width="60px"></a><br></div>

                        </section>
                    </section>

                    <section class="boton">
                        <a id="reg" href="index.php">
                            <div id="regresar">
