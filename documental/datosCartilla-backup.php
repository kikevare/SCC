   ...
   <div id="xdvContenedor" class="styContenedor">  
      ...
      <fieldset id="fsContenido" style="width: 700px;">
        ...
        <tr>	       
            ...
            <td class="styNCeldaDGral">
                <input type="text" id="num_oficio_sol" name="num_oficio_sol" size="22" maxlength="22" value='<?php echo $Datos[0]["NUM_OFICIO_SOL"];?>' class="text"  />
        ...
        <tr>	       
            ...
            <td class="styNCeldaDGral">
                <input type="text" id="num_oficio_resp" name="num_oficio_resp" size="22" maxlength="22" value='<?php echo $Datos[0]["NUM_OFICIO_RESP"];?>' class="text"  />
