...
<form name="fForm" id="fForm" method="post" action="#" enctype="application/x-www-form-urlencoded">
   <div id="xdvContenedor" class="styContenedor">  
      ...
      if( isset($_SESSION["menu"]) ){
        ...
        $Datos[0]["DEP_EXPIDE"]        = ( !empty($_POST["dep_expide"]) ) ? $_POST["dep_expide"]: "NULL";
        $Datos[0]["MUNICIPIO"]         = ( !empty($_POST["municipio"]) ) ? $_POST["municipio"]: "NULL";
        $Datos[0]["DATOS_INST"]        = $_POST["datos_inst"];
        $Datos[0]["MATRICULA"]         = $_POST["matricula"];
        $Datos[0]["PRE_ORIGINAL"]      = ( !empty($_POST["pre_original"]) ) ? $_POST["pre_original"]: "NULL";
        $Datos[0]["PRE_COPIA"]         = ( !empty($_POST["pre_copia"]) ) ? $_POST["pre_copia"]: "NULL"; 
		$Datos[0]["DOC_RESGUARDO"]     = ( !empty($_POST["doc_resguardo"]) ) ? $_POST["doc_resguardo"]: "NULL";  
		$Datos[0]["ESCOLARIDAD"]       = ( !empty($_POST["escolaridad"]) ) ? $_POST["escolaridad"]: "0";   
		$Datos[0]["CARRERA"]     	   = $_POST["carrera"];   
		$Datos[0]["EFICIENCIA"]        = ( !empty($_POST["eficiencia"]) ) ? $_POST["eficiencia"]: "1";     
        ...
        $Datos[0]["RESULTADO_COMP_EST"]= ( !empty($_POST["resultado_comp_est"]) ) ? $_POST["resultado_comp_est"]: "NULL"; 
