...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0 width=721
 ...
 <tr style='mso-yfti-irow:10;height:25.8pt'>
  ...
  if($Datos[0]["DOC_VALIDAR"]== 1){
   echo "CARTILLA (NO LIBERADA)";
  }
  if($Datos[0]["DOC_VALIDAR"]== 2){
   echo "CARTILLA Y HOJA DE LIBERACION";
  }
  if($Datos[0]["DOC_VALIDAR"]== 3){
   echo "CONSTANCIA DEL S.M.N.";
  }
  if($Datos[0]["DOC_VALIDAR"]== 4){
   echo "CARTILLA Y HOJA DE EXCEPCION";
  }
  if($Datos[0]["DOC_VALIDAR"]== 5){
   echo "OFICIO DE EXCEPTUACION";
  }
  ...
  if($Datos[0]["DOC_VALIDAR"]== 9){
   echo "RECIBO DE CARTILLA DEL SMN";
  }
  if($Datos[0]["DOC_VALIDAR"]== 10){
   echo "NO ENTREGO";
  }
  if($Datos[0]["DOC_VALIDAR"]== 11){
   echo "CARTILLA Y HOJA DE ANOTACION";
  }
