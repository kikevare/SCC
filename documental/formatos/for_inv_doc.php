<?php
    ...
    //RESPUESTA
    $pdf->CellFitScale(58, 5,$xPersona->AREAADSCRIP, "B", 0, "C");
    ...
    $pdf->SetXY(117,$y);
    $pdf->Cell(18, 5, "Municipio",0, 0, "L");
    $pdf->CellFitScale(68, 5, $xPersona->getMunicipio($xPersona->MPIOADSCRIP),"B", 0, "L");
    ...
    $lic110         = ( $DatosC[0]["DOC_VALIDAR"]== 7 ) ? "52" :"0";
    $lic067         = ( $DatosC[0]["DOC_VALIDAR"]== 8 ) ? "52" :"0";
    $recibo         = ( $DatosC[0]["DOC_VALIDAR"]== 9 ) ? "52" :"0";
    ...
    $pdf->SetFont("Arial", "", "10");
    $pdf->SetXY(15,$y);
    $pdf->Cell(65, 5, "LICENCIA 110.............................",0, 0, "L");
    $pdf->SetFont("ZapfDingbats","","10");
    //RESPUESTA
    $pdf->Cell(10,5,chr($lic110),0,0,"C");
    $pdf->SetFont("Arial", "", "11");
    $pdf->SetXY(80,$y);
    $pdf->Cell(10, 5, "(     )",0, 0, "L");
    ...
    $pdf->SetFont("Arial", "", "10");
    $pdf->SetXY(15,$y);
    $pdf->Cell(65, 5, "LICENCIA 067.............................",0, 0, "L");
    $pdf->SetFont("ZapfDingbats","","10");
    //RESPUESTA
    $pdf->Cell(10,5,chr($lic067),0,0,"C");
    $pdf->SetFont("Arial", "", "11");
    $pdf->SetXY(80,$y);
    $pdf->Cell(10, 5, "(     )",0, 0, "L");
    ...
    $pdf->SetFont("Arial", "", "10");
    $pdf->SetXY(100,$y);
    $pdf->Cell(93, 5, "RECIBO DE CARTILLA DEL SMN.........................................",0, 0, "L");
    $pdf->SetFont("ZapfDingbats","","10");
    //RESPUESTA
    $pdf->Cell(10,5,chr($recibo),0,0,"C");
    $pdf->SetFont("Arial", "", "10");
    $pdf->SetXY(193,$y);
    $pdf->Cell(10, 5, "(     )",0, 0, "L");
