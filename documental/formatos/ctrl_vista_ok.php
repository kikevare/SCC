...
if( isset($_SESSION["admitted_xsice"]) ){
   ...
   $jsxCredVista  = $xPath."includes/js/evesocial/invdoc/xvista.js";  
?>
...
<form name="fForm" id="fForm" method="post" action="#" enctype="application/x-www-form-urlencoded">
   <div id="xdvContenedor" class="styContenedor">  
      ...
      if( isset($_SESSION["menu"]) ){  
		...
		$txt = "Formato de Investigación Documental";
		$xArchivo = "for_inv_doc";
        	 
        $xSys->getNameMod($_SESSION["menu"], $txt);
      
      }
      //--------------------------------------------------------------------------//
      $archivo = $xArchivo . ".php";
      
      ?>
      <div id="dvTituloPdf">
   		<table width="100%" border="0" cellspacing="0" cellpadding="0">
      		<tr style="height: 60px;">
        			<td width="85%" align="left" style="color: gray; font-size: 10pt;">[Formatos] - Vista de Impresion</td>
