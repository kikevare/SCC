   ...
   <div id="xdvContenedor" class="styContenedor">  
      ...
      <fieldset id="fsContenido" style="width: 700px;">
        ...
        <tr id="trInsDoc" >
           ...
           <td class="styTdCampo">
              <select name="dep_expide" id="cbDependencia" class="select" <?php echo $Disa ?> > 
              <?php 
        ...
        <tr>	       
            ...
            <td class="styNCeldaDGral">
                <input type="text"  <?php echo $Disa ?> id="datos_int" name="datos_inst" size="60" value='<?php echo $Datos[0]["DATOS_INST"]; ?>' class="text" />
                <span style="color: black; font-weight: bold;">*</span>
            </td>	       
	    </tr>
        ...
        <tr>
           ...
           <td class="styTdCampo">
              <select name="entidad" id="cbEntidad" class="select"  <?php echo $Disa ?>> 
                 <option value="0">-- Seleccione --</option>                    
                 <?php                     
        ...
        <tr>
           ...
           <td class="styTdCampo">
              <select name="municipio" id="cbMpio" class="select" style="max-width: 350px;"  <?php echo $Disa ?>> 
              <?php              
    ...
    <tr>
        ...
        <tr id="trResDoc" >
           ...
           <td class="styTdCampo">
              <select name="resultado_comp_est" id="cbResultadoDoc" class="select" <?php echo $Disa ?>> 
                 <option value="0">-- Seleccione --</option>                    
                 <?php                     
