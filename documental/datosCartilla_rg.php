   ...
   <div id="xdvContenedor" class="styContenedor">  
      ...
      if( isset($_SESSION["menu"]) ){
        ...
        if ($_POST["doc_validar"] != 10){
            ...
            $Datos[0]["MUNICIPIO"]         = $_POST["dep_expide"] == "68" ? "NULL" : $_POST["mpio"];
            $Datos[0]["MATRICULA"]         = $_POST["matricula"];
            $Datos[0]["OTRO_ZONA"]         = $_POST["dep_expide"] == "68" ? $_POST["otro_zona"] : "";
           // $Datos[0]["YEAR"]              = $_POST["year"];
            ...
            $Datos[0]["FOLIO"]             = $_POST["folio"];

      }else{
            $Datos[0]["DOC_VALIDAR"]       = $_POST["doc_validar"];
            $Datos[0]["OTRO_DOC"]          = $_POST["doc_validar"] == "10" ? "" : $_POST["otro_doc"] ;
            $Datos[0]["DEP_EXPIDE"]        = $_POST["doc_validar"] == "10" ? "NULL" : $_POST["dep_expide"];
            $Datos[0]["MUNICIPIO"]         = $_POST["doc_validar"] == "10" ? "NULL" : $_POST["mpio"];
            $Datos[0]["MATRICULA"]         = $_POST["matricula"];
            $Datos[0]["OTRO_ZONA"]         = $_POST["doc_validar"] == "10" ? "" : $_POST["otro_zona"];
           // $Datos[0]["YEAR"]              = $_POST["year"];
            $Datos[0]["CLASE"]             = $_POST["doc_validar"] == "10" ? "NULL" : $_POST["clase"];

            $Datos[0]["PRE_ORIGINAL"]      = $_POST["doc_validar"] == "10" ? "NULL" : "";
            $Datos[0]["PRE_COPIA"]         = $_POST["doc_validar"] == "10" ? "NULL" : "";
            $Datos[0]["DOC_RESGUARDO"]     = $_POST["doc_validar"] == "10" ? "NULL" : "";
    		$Datos[0]["FECHA_SOL"]         = (!empty($_POST["fecha_sol"]) ) ? "'".$xSys->ConvertirFecha( $_POST["fecha_sol"], "yyyy-mm-dd" )."'" : "NULL";         
            $Datos[0]["NUM_OFICIO_SOL"]    = $_POST["num_oficio_sol"];
            $Datos[0]["FECHA_RESP"]        = ( !empty($_POST["fecha_resp"]) ) ? "'".$xSys->ConvertirFecha( $_POST["fecha_resp"], "yyyy-mm-dd" )."'" : "NULL"; 
            $Datos[0]["NUM_OFICIO_RESP"]   = $_POST["num_oficio_resp"];
            ...
            $Datos[0]["ANTECEDENTES"]      = $_POST["antecedentes"];
            $Datos[0]["TRAMITE"]           = $_POST["tramite"];
            $Datos[0]["FOLIO"]             = $_POST["folio"] == "10" ? "NULL" : $_POST["folio"];
