      ...
      <fieldset id="fsContenido" style="width: 700px;">
        ...
        <tr>	       
            ...
            <td class="styNCeldaDGral">
                <input type="text" id="datos_int" name="datos_inst" size="60" value='<?php echo $Datos[0]["DATOS_INST"]; ?>' />
                <span style="color: black; font-weight: bold;">*</span>
            </td>	       
	    </tr>
        ...
        <tr>	       
            ...
            <td class="styNCeldaDGral">
                <input type="text" id="num_oficio_sol" name="num_oficio_sol" size="20" maxlength="20" value='<?php echo $Datos[0]["NUM_OFICIO_SOL"]; ?>'  />
        ...
        <tr>	       
            ...
            <td class="styNCeldaDGral">
                <input type="text" id="num_oficio_resp" name="num_oficio_resp" size="20" maxlength="20" value='<?php echo $Datos[0]["NUM_OFICIO_RESP"]; ?>' />
