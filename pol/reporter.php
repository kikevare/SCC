...
header("Content-Disposition: attachment;filename=REPORTE_REXA.doc");
...
<?php
  if($xPsico->TIPO_EVAL =="PERMANENCIA LOC"){
      $DE="PERMANENCIA";
...
;?></o:p></span></p>
 ...
 <tr style='mso-yfti-irow:1;height:17.0pt'>
  ...
  <p class=MsoNoSpacing><span style='font-size:9.0pt;mso-bidi-font-size:10.0pt;
  font-family:"Arial",sans-serif;mso-bidi-font-family:"Times New Roman"'><o:p><?php echo $xPersona->APATERNO." ".$xPersona->AMATERNO." ".$xPersona->NOMBRE;?></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:2;height:17.0pt'>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:17.0pt'>
  <p class=MsoNoSpacing><span style='font-size:9.0pt;mso-bidi-font-size:10.0pt;
  font-family:"Arial",sans-serif;mso-bidi-font-family:"Times New Roman"'><o:p><?php echo $xPersona->RFC;?></o:p></span></p>
  </td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:17.0pt'>
  <p class=MsoNoSpacing><span style='font-size:9.0pt;mso-bidi-font-size:10.0pt;
  font-family:"Arial",sans-serif;mso-bidi-font-family:"Times New Roman"'><o:p><?php echo $xPersona->EDAD;?> A&Ntilde;OS</o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:3;height:17.0pt'>
  ...
  if($xPersona->getCategoria() == "POLICIA MUNICIPAL" || $xPersona->getCorporacion( $xPersona->CORPORACION ) == "SSPyPC MUNICIPAL"){
    ;
     $pdfr =  $xPersona->getCorporacion( $xPersona->CORPORACION )." (". $xPersona->getMunicipio($xPersona->MPIOADSCRIP) ." )" ;
 }else{
   
  $pdfr =  $xPersona->getCorporacion( $xPersona->CORPORACION );
 ...
 <tr style='mso-yfti-irow:4;height:17.0pt'>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:17.0pt'>
  <p class=MsoNoSpacing><span style='font-size:9.0pt;mso-bidi-font-size:10.0pt;
  font-family:"Arial",sans-serif;mso-bidi-font-family:"Times New Roman"'><o:p><?php echo $xPersona->getCategoria();?></o:p></span></p>
  </td>
 </tr>
 ...
 <tr style='mso-yfti-irow:7;mso-yfti-lastrow:yes;height:17.0pt'>
  ...
  <span
    ...
    style='mso-spacerun:yes'></span><o:p><?php echo $Datos[0]["EVANT"];?></o:p></span></p>
  ...
  <span
    lang=ES style='font-size:12.0pt;mso-bidi-font-size:10.0pt;font-family:"Tahoma",sans-serif;
    mso-bidi-font-family:"Times New Roman";mso-ansi-language:ES'><span
    ></span><o:p><?php echo $Datos[0]["TRALAB"];?></o:p></span></p>

<?php if($Datos[0]["ADM"]!="" || $Datos[0]["ADM"]!=null){?>
  ...
  <span
    lang=ES style='font-size:12.0pt;mso-bidi-font-size:10.0pt;font-family:"Tahoma",sans-serif;
    mso-bidi-font-family:"Times New Roman";mso-ansi-language:ES'><span
    ></span><o:p><?php echo $Datos[0]["ADM"];?></o:p></span></p>
  <?php }?>

<?php if($Datos[0]["OBS"]!="" || $Datos[0]["OBS"]!=null){?>
  ...
  <span
    lang=ES style='font-size:12.0pt;mso-bidi-font-size:10.0pt;font-family:"Tahoma",sans-serif;
    mso-bidi-font-family:"Times New Roman";mso-ansi-language:ES'><span
    ></span><o:p><?php echo $Datos[0]["OBS"];?></o:p></span></p>
  ...
  <span
    lang=ES style='font-size:12.0pt;mso-bidi-font-size:10.0pt;font-family:"Tahoma",sans-serif;
    mso-bidi-font-family:"Times New Roman";mso-ansi-language:ES'><span
    ></span><o:p><?php echo $Datos[0]["SITPAT"];?></o:p></span></p>
  ...
  <span
    lang=ES style='font-size:12.0pt;mso-bidi-font-size:10.0pt;font-family:"Tahoma",sans-serif;
    mso-bidi-font-family:"Times New Roman";mso-ansi-language:ES'><span
    ></span><o:p><?php echo $Datos[0]["ANALITEC"];?></o:p></span></p>
  ...
  <p class=MsoNormal style='text-align:justify;line-height:normal;
    ...
    style='mso-bidi-font-weight:normal'><span lang=ES style='font-size:12.0pt;
    mso-bidi-font-size:10.0pt;font-family:"Tahoma",sans-serif;mso-bidi-font-family:
    "Times New Roman";mso-ansi-language:ES'>CONCLUSION:<br><o:p></o:p></span></b>
  <span
    lang=ES style='font-size:12.0pt;mso-bidi-font-size:10.0pt;font-family:"Tahoma",sans-serif;
    mso-bidi-font-family:"Times New Roman";mso-ansi-language:ES'><span
    ></span><o:p><?php echo $Datos[0]["CONCLUSION"];?></o:p></span></p>
  </div>
  </td>
 </tr>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
   ...
   $DatosEvalS		= $xPsico->getDatEvaluador( $xPsico->CURP_SUPER ); 
   $Datosap = $xPsico->getDatosHojasr();
   ?>
 <tr style='mso-yfti-irow:2;mso-yfti-lastrow:yes;height:14.15pt'>
  ...
  style='font-size:9.0pt;mso-bidi-font-size:10.0pt;font-family:"Arial",sans-serif;
  mso-bidi-font-family:"Times New Roman"'>AP <?php echo $Datosap[0]["CLAVE_AUT"];?></span></b></a></span><span
  ...
  style='font-size:9.0pt;mso-bidi-font-size:10.0pt;font-family:"Arial",sans-serif;
  mso-bidi-font-family:"Times New Roman"'>AP <?php echo $DatosEvalS[0]["AP"];?></span></b></a></span><span
  style='mso-bookmark:tablaTotalHojas'><b style='mso-bidi-font-weight:normal'><span
  lang=ES-MX style='font-size:9.0pt;mso-bidi-font-size:10.0pt;font-family:"Arial",sans-serif;
  mso-bidi-font-family:"Times New Roman"'><o:p></o:p></span></b></span></p>
  </td>
