...
?>
    ...
    <body>
      ...
      */
                        ...
                        ?> <script>
                            $(document).ready(function() {
                                $("#actualizar_reporte").click(function() {
                                    ...
                                    url = "ajax_actualizar_reporte.php";
                                    $.ajax({
                                        type: "POST",
                                        url: url,
                                        data: {
                        ...
                        <script>
                            $(document).ready(function() {
                                $("#guardar_historial").click(function() {
                                    ...
                                    url = "ajax_guardar_historial.php";
                                    $.ajax({
                                        type: "POST",
                                        url: url,
                                        data: {
                        ...
                        $sqlev2 = "SELECT curp_evaluador, curp_supervisor, estado from poligrafia_evnu where id_evaluacion = '$id_evaluacion'";
                        $resultado_ev2 = mysqli_query($conexion, $sqlev2);
                        $fila_ev2 = mysqli_fetch_assoc($resultado_ev2);
                        $sql_resultado = "SELECT obs_supervisor,descrip_resultado, id_resultado, id_resultado_loc,observaciones, delitos_admision, delitos_deteccion, drogas_admision, drogas_deteccion, delincuencia_admision, delincuencia_deteccion, informacion_admision, informacion_deteccion, beneficios_admision, beneficios_deteccion, otros_admision, otros_deteccion, alcohol_admision, alcohol_deteccion, actividades_admision, actividades_deteccion from poligrafia_evnu where id_evaluacion = '" . $id_evaluacion . "'";
                        $resultado_res = mysqli_query($conexion, $sql_resultado);
                        $fila_resultado = mysqli_fetch_assoc($resultado_res);
                        $sql_reporte = "SELECT evaluaciones_anteriores,trayectoria_laboral,situacion_patrimonial,analisis_tecnico,conclusion,admision,observacion  from  reporte_poli where id_evaluacion = '$id_evaluacion'";
                        $resultado_reporte = mysqli_query($conexion, $sql_reporte);
                        $fila_reporte = mysqli_fetch_assoc($resultado_reporte);
                        $sql_indice = "SELECT reporte,hojagra,datosgen,proteccion,autorizacion,autorizacion_areas,antecedentes,entrevista,serie,hojacomen,alerta,revision,apeva,total,hojapreg from  indice_polnu where id_evaluacion = '$id_evaluacion'";
                        $resultado_indice = mysqli_query($conexion, $sql_indice);
                        $fila_indice = mysqli_fetch_assoc($resultado_indice);
                        $sql_his = "select * from reporte_polihis where id_evaluacion = '$id_evaluacion'";
                        $resultado_his = mysqli_query($conexion, $sql_his);
                        function estadoevaluacion($id_evaluacion, $conexion)
                        {
                            $sql = "SELECT estado from poligrafia_evnu where id_evaluacion='$id_evaluacion'";
                            $resultado = mysqli_query($conexion, $sql);
                            $fila = mysqli_fetch_assoc($resultado);
                            $estado = $fila['estado'];
                            if ($estado == '1') {
                        ...
                        {
                            $sql = "select * from reporte_polihis where id_evaluacion = '$id_evaluacion'";
                            $resultado = mysqli_query($conexion, $sql);
                            $contador = 0;
                        ...
                        {
                            $sqlev = "SELECT curp_evaluador, curp_supervisor from poligrafia_evnu where id_evaluacion = '$id_evaluacion'";
                        ...
                        function existereexa($conexion, $id_evaluacion, $curp_uso)
                        {
                            $sql1 = "SELECT id_evaluacion from poligrafia_evnu where reexaminacion='2' and id_evaluacion='$id_evaluacion'";
                            $resultado_n = mysqli_query($conexion, $sql1);
                            $oficio_r = mysqli_fetch_assoc($resultado_n);
                            $reexa = $oficio_r['id_evaluacion'];
                            if ($id_evaluacion == $reexa || $reexa != null) { ?>
                                <a href="reexa.php?id_evaluacion=<?php echo $id_evaluacion ?>&curpev=<?php echo $curp_uso ?>">Ir a Reexaminacion</a>
                            <?php    }
                        }
                                    ...
                                    while ($fila_alerta = mysqli_fetch_assoc($resultado_alerta)) {
                                        ...
                                        <?php if ($id_dep == 1) { ?>
                                            <style>
                                                @keyframes animLogo1 {
                                                    ...
                                                    50% {
                                                        background-image: linear-gradient(90deg, #fff7f7 0%, #033865 100%);
                                                    }
                                        ...
                                        <?php if ($id_dep == 2) { ?>
                                            <style>
                                                @keyframes animLogo3 {
                                                    ...
                                                    50% {
                                                        background-image: linear-gradient(90deg, #fff7f7 0%, #310365 100%);
                                                    }
                                        ...
                                        <?php if ($id_dep == 3) { ?>
                                            <style>
                                                @keyframes animLogo4 {
                                                    ...
                                                    50% {
                                                        background-image: linear-gradient(90deg, #fff7f7 0%, #b40242 100%);
                                                    }
                                        ...
                                        <?php if ($id_dep == 4) { ?>
                                            <style>
                                                @keyframes animLogo5 {
                                                    ...
                                                    50% {
                                                        background-image: linear-gradient(90deg, #fff7f7 0%, #717601 100%);
                                                    }
                                        ...
                                        <?php if ($id_dep == 7) { ?>
                                            <style>
                                                @keyframes animLogo6 {
                                                    ...
                                                    50% {
                                                        background-image: linear-gradient(90deg, #fff7f7 0%, #0b7103 100%);
                                                    }
                                        ...
                                        <?php if ($id_dep == 5) {  ?>
                                            <style>
                                                ...
                                                @keyframes animLogo {
                                                    25% {
                                                        background-image: linear-gradient(163deg, #fff7f7 0%, #650603 100%);
                                                    }

                                                    50% {
                                                        background-image: linear-gradient(90deg, #fff7f7 0%, #650603 100%);
                                                    }
                                                    ...
                                                    100% {
                                                        background-image: linear-gradient(90deg, #650603 0%, #fff7f7 100%);
                                                    }
                                                }
                        ...
                        background-size: contain;*/
                            ...
                            .infoev {
                                ...
                                border-radius: 15px;
                                background: #2699e6;
                                background: linear-gradient(0deg, #2699e6 0%, #000000 5%);
                            }
                            ...
                            #foto {
                                ...
                                border-bottom: double 8px #2699E6;
                                border-left: double 8px white;
                                border-right: double 8px #2699E6;
                            }
                            ...
                            #separador {
                                width: 80%;
                                height: 3px;
                                background: linear-gradient(to right, white, #2699E6);
                                margin-bottom: 10px;
                            }
                        ...
                        <section class="contenido">
                            ...
                            <section class="menu">
                                <div class="container">
                                    ...
                                    <?php if ($xUsr->xCurpEval != "GOAS851006MGRMRN02") { ?>
                                        <button id="boton_menu" name="rex2">Enviar a Reexaminacion <img
                                                src="<?php echo $xPath; ?>imgs/exp_pol.png" alt="" width="40px" height="95%"
                                    ...
                                    <?php if ($xUsr->xCurpEval == "GOAS851006MGRMRN02" || $xUsr->xCurpEval == "") { ?>
                                        ...
                                        <button id="boton_menu" name="enev"> Enviar a Evaluador <img
                                                ...
                                                style="margin-left: 2px;"> </button>
                                        <button id="boton_menu" name="rex">Enviar a Reexaminacion <img
                                                src="<?php echo $xPath; ?>imgs/exp_pol.png" alt="" width="40px" height="95%"
                                                style="margin-left: 2px;"> </button>
                            ...
                            <section class="datos">
                                <section class="infoev">
                                    ...
                                    <br> <a href="vista_nuevo_anteced.php?curpev=<?php echo $curp1 ?>" style=" font-size: 12px; color: white; text-decoration: none;">Informe de investigacion de antecedentes</a>
                                    <br>
                                    <?php existereexa($conexion, $id_evaluacion, $curp1) ?>
                                ...
                                <style>
                                    .asignar_elementos {
                                        width: 80%;
                                        height: 70%;
                                        background-image: linear-gradient(163deg, #2699E6 0%, #fff7f7 100%);
                                        border-radius: 20px;
                                        transition: all .3s;
                                        margin-top: 50px;
                                    }
                                    ...
                                    .asignar_elementos:hover {
                                        box-shadow: 0px 0px 30px 1px #2b547e;
                                    }
                                </style>
                                        ...
                                        <section class="asignar_elementos">
                                            <div class="card2">
                                                ...
                                                <br><br><?php if ($fila_ev2) { ?>
                                                    ...
                                                    </a><button class="button" name="desasignar">
                                                    ...
                                                    </button><?php  } else { ?><p> Encargado de Asignacion:</p>
                                                    ...
                                                    <button class="button" name="desasignar">
                                                        <span class="button_lg">
                                                            <span class="button_sl"></span>
                                                            <span class="button_text">Desasignar<img
                                                                    style="width: 20px; height: 20px; border-radius: 10px; margin-left: 5px; margin-right: 2px;"
                                ...
                                <?php if (isset($_POST['resul'])) { ?>
                                    <section class="eval_resultado">
                                        ...
                                        <section class="tabla_listado">
                                            ...
                                            <?php if ($fila_ev2['estado'] == '4') {
                                                echo "<p class='tx_fin'>La evaluacion ha sido finalizada</p>";
                                            } else { ?>
                                ...
                                <?php if (isset($_POST['guardar_resultadoev'])) {
                                    $upda = "UPDATE poligrafia_evnu set fecha_resultado='" . $hoy . "' , id_resultado = '" . $_POST['resultadories'] . "', id_resultado_loc = '" . $_POST['resultado_tecnico'] . "', descrip_resultado = '" . $_POST['analisis_numerico'] . "',
               ...
               alert('Los datos no han podido actualizarse...');
                                ...
                                <?php if (isset($_POST['rex'])) {
                                    $upda = "UPDATE poligrafia_evnu set reexaminacion='1' where id_evaluacion='$id_evaluacion'";
                                    $resed = mysqli_query($conexion, $upda);
                                    if ($resed) {
                                        echo "<script languaje='JavaScript'>
               alert('El evaluado ha sido dirigido a reexaminacion con exito...');
               </script>";
                                    } else {
                                        echo "<script languaje='JavaScript'>
               alert('No se ha podido relaizar la accion, asigne la evaluacion para enviar a reexaminacion...');
               </script>";
                                    }
                                } ?>
                                <?php if (isset($_POST['rex2'])) {
                                    $upda = "UPDATE poligrafia_evnu set reexaminacion='0' where id_evaluacion='$id_evaluacion'";
                                    $resed = mysqli_query($conexion, $upda);
                                    if ($resed) {
                                        echo "<script languaje='JavaScript'>
               alert('El evaluado ha sido dirigido a reexaminacion con exito...');
               ...
               alert('No se ha podido relaizar la accion, asigne la evaluacion para enviar a reexaminacion...');
                                            ...
                                            <div class="card2">
                                                ...
                                                <section class="fila_indice">
                                                    <div id="fila_indice">Reporte: <input type="text" id="uno" name="ireporte"
                                                            ...
                                                            value="<?php echo $fila_indice['reporte'] ?>">
                                                        Hoja de Calificacion de Graficos: <input type="text" id="dos"
                                                            name="ihojagra" oninput="sumar(this.value);"
                                                            value="<?php echo $fila_indice['hojagra'] ?>">
                                                        Hoja de Preguntas: <input type="text" name="ihojapre"
                                                            oninput="sumar(this.value);"
                                                            value="<?php echo $fila_indice['hojapreg'] ?>">
                                                    </div>
                                                    <div id="fila_indice">Datos Generales: <input type="text" name="idatos"
                                                            oninput="sumar(this.value);"
                                                            value="<?php echo $fila_indice['datosgen'] ?>">
                                                        Proteccion de Datos: <input type="text" name="iprotec"
                                                            oninput="sumar(this.value);"
                                                            value="<?php echo $fila_indice['proteccion'] ?>"> Autorizacion de
                                                        examen:
                                                    ...
                                                    <div id="fila_indice">Autorizacion de Areas: <input type="text"
                                                            ...
                                                            value="<?php echo $fila_indice['autorizacion_areas'] ?>">
                                                        Antecedentes
                                                        Personales: <input type="text" name="iantecedentes"
                                                            oninput="sumar(this.value);"
                                                            value="<?php echo $fila_indice['antecedentes'] ?>"> Entrevista:
                                                        <input type="text" name="ientrevista" oninput="sumar(this.value);"
                                                            value="<?php echo $fila_indice['entrevista'] ?>">
                                                    </div>
                                                    <div id="fila_indice">Serie de Graficos: <input type="text" name="iserie"
                                                            oninput="sumar(this.value);"
                                                            value="<?php echo $fila_indice['serie'] ?>">
                                                        Hoja de Comentarios: <input type="text" name="ihojaco"
                                                            oninput="sumar(this.value);"
                                                            value="<?php echo $fila_indice['hojacomen'] ?>"> Alerta de Riesgo:
                                                        <input type="text" name="ialerta" oninput="sumar(this.value);"
                                                            value="<?php echo $fila_indice['alerta'] ?>">
                                                    </div>
                                                    <div id="fila_indice">Revision de Antecedentes: <input type="text"
                                                            name="irevision" oninput="sumar(this.value);"
                                                            value="<?php echo $fila_indice['revision'] ?>">
                                    ...
                                    <section class="in_reporte">
                                        ...
                                        <section class="rubros_reporte">
                                            ...
                                            <p style="font-family: oswald; font-size: 16px; color: white;">Evaluaciones
                                                Anteriores: </p><textarea class="txtarea2"
                                        ...
                                        <section class="rubros_reporte">
                                            <p style="font-family: oswald; font-size: 16px; margin-top: 5px; color: white; ">
                                                Trayectoria Laboral: </p><textarea name="tray"
                                        ...
                                        <?php if ($fila_ev2['estado'] == '4') {
                                            ...
                                            <?php if ($fila_reporte) { ?>
                                                <button class="button" name="actualizar_reporte" id="actualizar_reporte" type="button">
                                                    <span class="button_lg">
                                                        <span class="button_sl"></span>
                                                        <span class="button_text">Actualizar<img
                                                                style="width: 20px; height: 20px; border-radius: 10px; margin-left: 5px; margin-right: 2px;"
                                                ...
                                                <button class="button" type="button" id="guardar_historial">
                                                    <span class="button_lg">
                                                        <span class="button_sl"></span>
                                            ...
                                            <?php   } else {  ?>
                                                <button class="button" name="guardar_reporte" id="guardar_reporte" type="button">
                                                    <span class="button_lg">
                                                        <span class="button_sl"></span>
                                                        <span class="button_text">Guardar<img
                                                                style="width: 20px; height: 20px; border-radius: 10px; margin-left: 5px; margin-right: 2px;"
                                ...
                                <?php if (isset($_POST['documentos'])) { ?>
                                    ...
                                    <?php $sql = "SELECT nombre, a_paterno, a_materno,id_tipo_eval, id_corporacion,categoria,fecha from tbprog_preliminar where xcurp = '" . $curp1 . "' order by id_prog_preliminar desc";
                                    $resultado = mysqli_query($conexion, $sql);
                                    $fila = mysqli_fetch_assoc($resultado);
                                    $id_corpo = $fila['id_corporacion'];
                                    $id_tip = $fila['id_tipo_eval'];
                                    ...
                                    $sql7 = "SELECT reporte,hojagra,datosgen,hojapreg,proteccion,autorizacion,autorizacion_areas,antecedentes,entrevista,serie,hojacomen,alerta,revision,apeva,total from indice_polnu where id_evaluacion='$id_evaluacion'";
                                    $resultado7 = mysqli_query($conexion, $sql7);
                                    $fila7 = mysqli_fetch_assoc($resultado7);
                                    $sql8 = "SELECT fecha_resultado from poligrafia_evnu where id_evaluacion = '" . $id_evaluacion . "'";
                                    ...
                                    <div id="container-main">
                                        ...
                                        <div class="accordion-container">
                                            ...
                                            <div class="accordion-content">
                                                <section class="hoja">
                                                    ...
                                                    <section class="tabla_datosdoc">
                                                        <div id="filas_datos">
                                                            ...
                                                            <p
                                                                style="width: 20%; height: 100%;font-family: arima; font-size: 12px; margin-left: 5px;">
                                                                <?php echo $fila8['fecha_resultado'] ?></p>
                                                        </div>
                                                ...
                                                <a href="reporte.php">Descargar</a>
                                            </div>
                                        </div>
                        ...
                        <?php if (isset($_POST['guardar_indice'])) {
                            ...
                            $query = "INSERT INTO indice_polnu (id_evaluacion, curp_evaluador, curp_supervisor,reporte,hojagra,datosgen,proteccion,autorizacion,autorizacion_areas,antecedentes,entrevista,serie,hojacomen,alerta,revision,apeva,total,hojapreg) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
$upda = "UPDATE poligrafia_evnu set curp_evaluador='', curp_supervisor='' where id_evaluacion = '$id_evaluacion'";
                            $resed = mysqli_query($conexion, $upda); ?>
                            <script languaje='JavaScript'>
...
<?php } ?>
                        <?php if (isset($_POST['finev'])) {
                            $estado_lib = '1';
                            $reexa = '0';
                            $upda = "UPDATE poligrafia_evnu set estado='4' where id_evaluacion = '$id_evaluacion'";
                            $resed = mysqli_query($conexion, $upda);
                        ...
                        <?php if (isset($_POST['enjef'])) {
                            $upda = "UPDATE poligrafia_evnu set estado='3' where id_evaluacion = '$id_evaluacion'";
                            $resed = mysqli_query($conexion, $upda);
                            if ($resed) {
                                echo "<script languaje='JavaScript'>
        ...
        alert('No ha podido enviarse la evaluacion...');
                        ...
                        <?php if (isset($_POST['ensup'])) {
                            $upda = "UPDATE poligrafia_evnu set estado='2' where id_evaluacion = '$id_evaluacion'";
                            $resed = mysqli_query($conexion, $upda);
                            if ($resed) {
                                echo "<script languaje='JavaScript'>
        ...
        alert('No ha podido enviarse la evaluacion...');
                        ...
                        <?php if (isset($_POST['enev'])) {
                            $upda = "UPDATE poligrafia_evnu set estado='1' where id_evaluacion = '$id_evaluacion'";
                            $resed = mysqli_query($conexion, $upda);
                            if ($resed) {
                                echo "<script languaje='JavaScript'>
        ...
        alert('No ha podido enviarse la evaluacion...');
                        ...
                        if (isset($_POST['guardar_modal2'])) {
                            ...
                            $upda = "UPDATE poligrafia_evnu set curp_evaluador = '$evnu', curp_supervisor='$supnu' where id_evaluacion='$id_evaluacion' ";
                            $resed = mysqli_query($conexion, $upda);
                            if ($resed) {
                                echo "<script languaje='JavaScript'>
