...
$dbpass='4dminMy$ql$';
      ...
      <div><textarea name="aler" id="al" cols="30" rows="10"><?php echo utf8_decode( $filas['descripcion'])?></textarea></section>
      <?php
      if (isset($_POST['guardar'])) {
        $descripcion=utf8_encode ($_POST['aler']);
    ...
    <section class="botones"><div> <button name="guardar" id="guar">Guardar</button></div>
    <a id="reg" href="historial_alertas.php"><div id="regresar"><p id="regr"> Regresar</p></div></a></section></form>
    </html>
    <style>
        #enca 
        {
