...
$sql = "SELECT nombre, a_paterno, a_materno,id_tipo_eval, id_corporacion,categoria,fecha from tbprog_preliminar where xcurp = '".$curp1."' order by id_prog_preliminar desc";
    ...
    $sql6 = "SELECT reporte,hojagra,datosgen,hojapreg,proteccion,autorizacion,autorizacion_areas,antecedentes,entrevista,serie,hojacomen,alerta,revision,apeva,total from indice_polnu_rex where id_evaluacion='$id_evaluacion'";
