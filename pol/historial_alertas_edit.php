...
$dbpass='4dminMy$ql$';
     ...
     <div id="nom"><P id="encab"> DESCRIPCI&Oacute;N</P></div>
        ...
        <div id="ev"><P id="encab"> -</P></div></section>
        ...
        <section class="alertas">
           ...
           <?php }?>
            ...
            if ($xUsr->xCurpEval==$filas['curp_evaluador']) {
                ?>
               <div id="ed"> <a id="edit" href="historial_alertas_cambio.php?id=<?php echo $filas['id_alerta']?>"><p id="editar"> <img src="<?php echo $xPath;?>imgs/edtr.png" alt="" width="37px"></p></a></div>
            <?php } ?>
        </section></section>
        <?php
      }
      ?>
      <section class="boton">
      <a id="reg" href="historial_alertas.php"><div id="regresar"><p id="regr"> Regresar</p></div></a></section>
      <style>
    #encab 
    {
        font-weight: bold;
