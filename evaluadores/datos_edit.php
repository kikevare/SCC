...
<form name="fForm" id="fForm" method="post" action="#" onsubmit="return validar();" enctype="application/x-www-form-urlencoded">
   <div id="xdvContenedor" class="styContenedor">  
      ...
      if( isset($_SESSION["menu"]) ){
         $xSys->getNameMod($_SESSION["menu"], "Modificacion");         
      }
      ?>      
         ...
         <table class="stytbContenido" cellpadding="0" cellspacing="0" border="0">
            <tr>
               ...
               <td class="styTdCampo" width="500">                     
                  <input name="curp" id="txtCurp" size="25" maxlength="18" value="<?php echo $xPersona->CURP;?>" class="textread" readonly="true" />
            ...
            <tr>
               ...
               <td class="styTdCampo">                     
                  <input name="nombre" id="txtNombre" size="30" maxlength="35" value="<?php echo $xPersona->NOMBRE;?>" class="text" />
                  <span style="color: red; font-weight: bold;">*</span> 
               </td>
            </tr>
            <tr>
               ...
               <td class="styTdCampo">                     
                  <input name="a_paterno" id="txtAPaterno" size="30" maxlength="30" value="<?php echo $xPersona->APATERNO;?>" class="text" />
                  <span style="color: red; font-weight: bold;">*</span>
               </td>
            </tr>              
            <tr>
               ...
               <td class="styTdCampo">
                  <input name="a_materno" id="txtAMaterno" size="30" maxlength="30" value="<?php echo $xPersona->AMATERNO;?>" class="text" />
                  <span style="color: red; font-weight: bold;">*</span> 
               </td>
            </tr>
            <tr>
               ...
               <td class="styTdCampo">
                  <?php
                  $fecha_nac = $xSys->FormatoCorto( date("d-m-Y", strtotime($xPersona->FECHANAC)) );
                  ?>
                  <input name="fecha_nac" id="txtFechaNac" size="12" value="<?php echo $fecha_nac;?>" class="textread" readonly="true" style="text-align: center;" />
                  <span style="color: red; font-weight: bold;">*</span> 
               </td>
            </tr>               
            <tr>
            ...
            <tr>
               ...
               <td class="styTdCampo">                     
                  <input name="rfc" id="txtRfc" size="17" maxlength="13" value="<?php echo $xPersona->RFC;?>" class="text" />
                  <span style="color: red; font-weight: bold;">*</span> 
               </td>
            </tr>               
            <tr>
               ...
               <td class="styTdCampo">                     
                  <input name="cuip" id="txtCuip" size="25" maxlength="20" value="<?php echo $xPersona->CUIP;?>" class="text" />                  
               </td>
            </tr>            
            <tr>
               <td class="styTdNombreCampo">Folio I.F.E.:</td>
               <td class="styTdCampo">                     
                  <input name="ife" id="txtIfe" size="22" maxlength="18" value="<?php echo $xPersona->IFE;?>" class="text" /> 
               </td>
            </tr>
            <tr>
               <td class="styTdNombreCampo">Cartilla Militar:</td>
               <td class="styTdCampo">                     
                  <input name="cartilla" id="txtCartilla" size="15" maxlength="10" value="<?php echo $xPersona->CARTILLA;?>" class="text" /> 
               </td>
            </tr> 
            <tr>
               ...
               <td class="styTdCampo">
                  <select name="entidad" id="cbEntidad" class="select">
                     ...
                     $xCat->shwEntidad($xPersona->ENTIDAD);                     
                     ?>
                  </select>
                  <span style="color: red; font-weight: bold;">*</span>                  
               </td>
            ...
            <tr>
               ...
               <td class="styTdCampo">
                  <select name="mpio_nac" id="cbMpioNac" class="select" style="max-width: 350px;"> 
                     <?php
                     if( $xPersona->ENTIDAD != "" )
                        $xCat->shwMunicipio($xPersona->MPIONAC, $xPersona->ENTIDAD);
                     else
            ...
            <tr>
               ...
               <td class="styTdCampo">                     
                  <input name="localidad" id="txtLocalidad" size="55" maxlength="200" value="<?php echo $xPersona->LOCALIDAD;?>" class="text" /> 
               </td>
            </tr>
         </table>         
      </fieldset>
      ...
      <fieldset id="fsContenido" style="width: 700px;">
         ...
         <table class="stytbContenido" cellpadding="0" cellspacing="0" border="0">
            <tr>
               <td class="styTdNombreCampo" style="width: 200px;">area evaluadora:</td>
               <td class="styTdCampo" style="width: 500px;">
                  <select name="area" id="cbArea" class="select">
                     <?php
                     $xCat->shwAreaEval( $xPersona->AREAEVAL );
                     ?>
                  </select>
                  <span style="color: red; font-weight: bold;">*</span>                  
               </td>
            ...
            <tr>
               ...
               <td class="styTdCampo">
                  <?php
                  $fecha_ing = $xSys->FormatoCorto( date("d-m-Y", strtotime($xPersona->FECHAING)) );
                  ?>
                  <input name="fecha_ing" id="txtFechaIng" size="15" value="<?php echo $fecha_ing;?>" class="textread" readonly="true" style="text-align: center;" />                  
                  <span style="color: red; font-weight: bold;">*</span> 
               </td>
            </tr>               
            <tr>
               ...
               <td class="styTdCampo">
                  <select name="funcion" id="cbFuncion" class="select">                     
                     <?php       
                     $xCat->shwTipoFuncion($xPersona->TIPOFUNCION);
                     ?>
                  </select>
                  <span style="color: red; font-weight: bold;">*</span>                  
               </td>
            ...
            <tr>
               <td class="styTdNombreCampo" width="200">Corporaci&oacute;n:</td>
               <td class="styTdCampo" width="400">
                  <select name="corporacion" id="cbCorporacion" class="select">
                     <option value="0">-- Seleccione --</option>
                     <?php
                     $xCat->shwCorporacion($xPersona->CORPORACION);
                     ?>
                  </select>
                  <span style="color: red; font-weight: bold;">*</span>
               </td>
            ...
            <tr>
               ...
               <td class="styTdCampo">
                  <select name="especialidad" id="cbEspecialidad" class="select">
                     <?php
                     $xCat->shwEspecialidad($xPersona->ESPECIALIDAD, $xPersona->CORPORACION);
                     ?>
                  </select>
                  <span style="color: red; font-weight: bold;">*</span>
            ...
            <tr>
               ...
               <td class="styTdCampo">
                  <select name="categoria" id="cbCategoria" class="select"> 
                     <?php  
                     $xCat->shwCategoria($xPersona->CATEGORIA);
                     ?>
                  </select>
                  <span style="color: red; font-weight: bold;">*</span>
            ...
            <tr>
               ...
               <td class="styTdCampo">                     
                  <input name="cargo" id="txtCargo" size="50" maxlength="250" value="<?php echo $xPersona->CARGO;?>" class="text" />
                  <span style="color: red; font-weight: bold;">*</span> 
               </td>
            </tr>
            <tr>
               ...
               <td class="styTdCampo">                     
                  <input name="area_ads" id="txtArea" size="60" maxlength="200" value="<?php echo $xPersona->AREAADSCRIP;?>" class="text" />
                  <span style="color: red; font-weight: bold;">*</span> 
               </td>
            </tr>
            <tr>
               ...
               <td class="styTdCampo">
                  <select name="region" id="cbRegion" class="select">                                        
                     <?php   
                     if( $xPersona->MPIOADSCRIP == "" )
                        echo"<option value='0'>-- Seleccione --</option>";                  
                     $xCat->shwRegion($xPersona->REGION);
                     ?>
                  </select>
               </td>
            </tr>   
            <tr>
               ...
               <td class="styTdCampo">
                  <select name="mpio_ads" id="cbMpioAds" class="select" style="max-width: 350px;"> 
                     <?php
                     if( $xPersona->REGION != "" )
                        $xCat->shwMunicipio($xPersona->MPIOADSCRIP, 0, $xPersona->REGION);
                     else
                        echo"<option value='0'>-- Vacio --</option>";
                     ?>
                  </select>
            ...
            <tr>
               <td class="styTdNombreCampo">CLAVE EVALUADOR:</td>
               <td class="styTdCampo">                     
                  <input name="ap" id="txtAp" size="60" maxlength="100" value="<?php echo $xPersona->AP;?>" class="text" />
               </td>
            </tr>
         </table>
      </fieldset>
      ...
      <fieldset id="fsContenido" style="width: 700px;">
         ...
         <table class="stytbContenido" border="0" cellpadding="0" cellspacing="0">            
            <tr>
               ...
               <td class="styTdCampo" width="500">                     
                  <input name="calle" id="txtCalle" size="55" maxlength="60" value="<?php echo $xPersona->CALLE;?>" class="text" />
                  <span style="color: red; font-weight: bold;">*</span> 
               </td>
            </tr>
            <tr>
               ...
               <td class="styTdCampo">
                  <input name="num_ext" id="txtNumExt" size="5" maxlength="4" value="<?php echo $xPersona->NUMEXT;?>" class="text" />
                  <span style="color: red; font-weight: bold;">*</span> 
               </td>
            </tr>    
            <tr>
               ...
               <td class="styTdCampo">                     
                  <input name="num_int" id="txtNumInt" size="5" maxlength="4" value="<?php echo $xPersona->NUMINT;?>" class="text" />
            ...
            <tr>
               ...
               <td class="styTdCampo">                     
                  <input name="colonia" id="txtColonia" size="60" maxlength="50" value="<?php echo $xPersona->COLONIA;?>" class="text" />
                  <span style="color: red; font-weight: bold;">*</span> 
               </td>
            </tr> 
            <tr>
               ...
               <td class="styTdCampo">                     
                  <input name="ciudad" id="txtCiudad" size="60" maxlength="50" value="<?php echo $xPersona->CIUDAD;?>" class="text" />
                  <span style="color: red; font-weight: bold;">*</span> 
               </td>
            </tr>
            <tr>
               ...
               <td class="styTdCampo">
                  <select name="mpio_domi" id="cbMpioDomi" class="select" style="max-width: 350px;">
                     <?php                     
                     $xCat->shwMunicipio($xPersona->MPIODOMI, 12);                     
                     ?>
                  </select>
                  <span style="color: red; font-weight: bold;">*</span>                  
               </td>
            ...
            <tr>
               ...
               <td class="styTdCampo">                     
                  <input name="tel_fijo" id="txtTelFijo" size="15" maxlength="15" value="<?php echo $xPersona->TELFIJO;?>" class="text" />
               </td>
            </tr>
            <tr>
               <td class="styTdNombreCampo">Telefono movil:</td>
               <td class="styTdCampo">                     
                  <input name="tel_movil" id="txtTelMovil" size="15" maxlength="15" value="<?php echo $xPersona->TELMOVIL;?>" class="text" /> 
               </td>
            </tr>
         </table>
      </fieldset>
      ...
      <fieldset id="fsContenido" style="width: 700px;">
         ...
         <table class="stytbContenido" border="0" cellpadding="0" cellspacing="0">            
            ...
            <tr>
               ...
               <td class="styTdCampo">                     
                  <input name="nomenclatura" id="txtNomenclatura" size="10" maxlength="10" value="<?php echo $xPersona->NOMENCLAT;?>" class="text" /> 
               </td>
            </tr>
            <tr>
               <td class="styTdNombreCampo">Cedula Profesional:</td>
               <td class="styTdCampo">                     
                  <input name="cedula" id="txtCedula" size="10" maxlength="10" value="<?php echo $xPersona->CEDULA;?>" class="text" /> 
                  <span style="color: red; font-weight: bold;">*</span>                  
               </td>
            </tr>
            <tr>
               <td class="styTdNombreCampo">Especialidad:</td>
               <td class="styTdCampo">                     
                  <input name="ne_especialidad" id="txtEspecialidad" size="60" maxlength="100" value="<?php echo $xPersona->ESPEST;?>" class="text" />
               </td>
            </tr> 
         ...
         <table class="stytbBotones" cellpadding="0" cellspacing="0">
            <tr>
               <td width="30%" align="right">
                  <input type="submit" name="btnAceptar" value="Guardar cambios" class="stybtnNormal"/>
               </td>
               <td width="40%">&nbsp;</td>
   ...
   <input type="hidden" name="tp_oper" id="xtp_oper" value="2" />
</form>
</td></tr>
