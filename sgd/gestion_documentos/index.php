   ...
   ?>
      ...
      */
      ...
      ?>
                        ...
                        <div id="modal3" class="modalmask">
                            <div class="modalbox movedown">
                                ...
                                <section class="crear_ex">
                                    ...
                                    <?php if (file_exists('Archivos/Oficio_solicitud/' . $carpeta . '/')) {  ?>
                        ...
                        <div id="modal4" class="modalmask">
                            <div class="modalbox movedown">
                                ...
                                <section class="crear_ex">
                                    ...
                                    <?php if (file_exists('Archivos/Acuse/' . $carpeta . '/')) {  ?>
                                    <form action="" method="POST" enctype="multipart/form-data" id="for">
                ...
                if (isset($_POST['crear2'])) {
                    if (!file_exists('./Archivos/Acuse/' . $carpeta . '/')) {
                        mkdir('./Archivos/Acuse/' . $carpeta . '/', 0777, true);
                ...
                if (isset($_FILES['image2'])) {
                    ...
                    if (empty($errors) == true) {
                        move_uploaded_file($file_tmp, './Archivos/Acuse/' . $carpeta . '/' . $carpeta.$file_name);
                        echo "<script languaje='JavaScript'>
    ...
    $dbpass = 'root';
     ...
     $dbpass='4dminMy$ql$';*/
          ...
          $sql_folio = "SELECT numero_oficio,n_fila FROM informacion_sgd order by n_fila desc";
          $resulfolio = mysqli_query($conexion, $sql_folio);
          $folio_fila = mysqli_fetch_assoc($resulfolio);
          $sql_espera = "SELECT * FROM informacion_sgd where curp_usuario ='$xUsr->xCurpEval' and estatus='2'";
          $resulespera = mysqli_query($conexion, $sql_espera);
          $sql_espera2 = "SELECT * FROM informacion_sgd where curp_encargado ='$xUsr->xCurpEval' and estatus='1'";
          $resulespera2 = mysqli_query($conexion, $sql_espera2);
          $sql_espera3 = "SELECT * FROM informacion_sgd where curp_encargado ='$xUsr->xCurpEval' and estatus='1'";
          $resulespera3 = mysqli_query($conexion, $sql_espera3);
          $sql_todos = "SELECT * FROM informacion_sgd order by fecha_recibido desc";
          $resultodos = mysqli_query($conexion, $sql_todos);
          $sql_todos2 = "SELECT * FROM informacion_sgd where curp_encargado ='$xUsr->xCurpEval' order by fecha_recibido desc";
         ...
         $nom_eval = $fil7['a_paterno']." ".$fil7['a_materno']." ".$fil7['nombre'];
          $fecha_hoy = $fec_hoy;
                        ...
                        {
                            if ($stat==1) { ?>
                        <img src="<?php echo $xPath;?>imgs/reloj.gif" alt="" width="55px"
                        ...
                        <?php   }
                              if ($stat==2) { ?>
                        <img src="<?php echo $xPath;?>imgs/buscar.gif" alt="" width="55px"
                        ...
                        <?php   }
                                if ($stat==3) { ?>
                        <img src="<?php echo $xPath;?>imgs/comprobado.gif" alt="" width="65px"
                            style="margin-right: 7px; margin-left: 2px; margin-top: 10px;"><br>
                        ...
                        <?php } else { ?>
                        <a href="vista.php?ruta=<?php echo $rutacompleta ?>"><img
                                src="<?php echo $xPath;?>imgs/pdf_loge.png" alt="" width="50px"
                                style="margin-right: 7px; margin-left: 2px; margin-top: 10px;"></a>
                        <p style="font-family: oswald; font-size: 14px; margin-top: 5px">Documento Enviado</p>
                        <?php   }
 }
  }
   }
                    ...
                    { ?>
                        ...
                        <?php   } }
        function documento_acuse ($folio_soli, $xPath,$fac)
        {
            ...
            while (($archivo = readdir($gestor)) !== false) {
                ...
                if ($archivo != "." && $archivo != "..") {
                    ...
                    if (is_dir($rutacompleta)) { ?>
                        ...
                        <a href="vista.php?ruta=<?php echo $rutacompleta ?>"><img
                                src="<?php echo $xPath;?>imgs/pdf_loge.png" alt="" width="50px"
                                style="margin-right: 7px; margin-left: 5px; margin-top: 10px;"></a>
                        <p style="font-family: oswald; font-size: 14px; margin-top: 5px">Documento Enviado</p>
    ...
    { ?>
                        <a id="sub" href="subir.php?nom=<?php echo $folio_soli ?>&fac=<?php echo $fac ?> "><img
                                src="<?php echo $xPath;?>imgs/archivo.png" alt="" width="60px"
...
?>
                        ...
                        <div id="modal2" class="modalmask">
                            <div class="modalbox movedown">
                                ...
                                <div id="are_insert1">
                                    <p> Nombre de Area: </p> <input name="area_inde" type="text" id="area_inde">
                                </div>
                                <!--     <div id="are_insert1">
                                ...
                                <input type="button" name="b_gmodal2" id="b_modal12" value="Guardar">
                            </div>
                        ...
                        <script>
                              ...
                              $(document).ready(function() {
                                 $('#b_modal12').click(function() {
                              var id = $('#area_inde').val();
                              ...
                              $.ajax( {
                                 ...
                                 {
                                    alert('Se agrego correctamente el area...');
                        ...
                        <section class="all_content">
                            <section class="menu">
                                <?php if ($xUsr->xCurpEval=='OEOA850214MGRRRN00'||$xUsr->xCurpEval=='LOAE841026MGRPRL06'||$xUsr->xCurpEval=='0') {?>


                                <div id="prese">
                                    <p id="text_prese">SGD</p><img src="<?php echo $xPath;?>imgs/CORREO.png" alt="">
                                </div>
                                <div id="lista"><button id="b_menu" name="nuevo"><img
                                            src="<?php echo $xPath;?>imgs/agregar.png" alt="" width="35px"
                                            style="margin-right: 10px; margin-left: -10px; ">Nuevo Documento</button>
                                </div>
                                <div id="lista"><button id="b_menu" name="espera"><img
                                            src="<?php echo $xPath;?>imgs/tiempo.png" alt="" width="35px"
                                            style="margin-right: 7px; margin-left: 2px;"> Espera de Respuesta</button>
                                </div>
                                <div id="lista"><button id="b_menu" name="busqueda"><img
                                            src="<?php echo $xPath;?>imgs/buscar.png" alt="" width="35px"
                                            style="margin-right: 7px; margin-left: 22px;"> Busqueda de Documentos</button></div>
                                <div id="lista"><button id="b_menu" name="bandeja"><img
                                            src="<?php echo $xPath;?>imgs/bandeja.png" alt="" width="35px"
                                            style="margin-right: 7px; margin-left: 2px;"> Todos los Documentos</button>
                                </div>
                                <?php  }else { ?>
                                <div id="prese">
                                    <p id="text_prese">SGD</p><img src="<?php echo $xPath;?>imgs/CORREO.png" alt="">
                                </div>
                                <div id="lista"><button id="b_menu" name="espera2"><?php while ($filaes3 = mysqli_fetch_assoc($resulespera3)) {
                                       if (!empty($filaes3) ) { $contador=0; $contador=$contador+1 ?>

                                        <?php  } 
                                   
                                    } if ($contador>=1 ) { ?>
                                        <img src="<?php echo $xPath;?>imgs/activo.png" alt="" style="width: 30px;">
                                        <?php  } ?><img src="<?php echo $xPath;?>imgs/tiempo.png" alt="" width="35px"
                                            style="margin-right: 7px; margin-left: 2px;"> Espera de Respuesta</button>
                                            <div id="lista"><button id="b_menu" name="bandeja2"><img
                                            src="<?php echo $xPath;?>imgs/bandeja.png" alt="" width="35px"
                                            style="margin-right: 7px; margin-left: 2px;"> Documentos Enviados</button>
                                </div>
                                    <?php  } ?>
                            </section>
                            <?php 
         ...
         alert('El archivo no pudo subirse al expediente, es demasiado pesado o no es un formato compatible');
                ...
                ?>
                            ...
                            <section style="display: inline-block; width: 100%; max-height: 700px;">
                                <p id="tx_info">Busqueda de Documentaci&oacute;n</p>
                                <div id="separador"></div>
                                <section class="bus_doc">
                                    <select name="id_bus" id="">
                                        <option value="1">Dependencia</option>
                                        <option value="2">Area</option>
                                        <option value="3">Asunto</option>
                                    </select> <input name="in_bus" type="text"> <input type="submit" value="Buscar"
                                        name="buscar">
                                </section>
                            </section><?php }
                                if (isset($_POST['buscar'])) {
                                    $dep = $_POST['in_bus'];
                                    if ($_POST['id_bus']==1) {
                                        $sql_busq = "SELECT * from informacion_sgd where dependencia = '$dep' order by fecha_oficio desc";
                                        $resbd = mysqli_query($conexion, $sql_busq); ?>
                            <section style="display: inline-block; width: 100%; max-height: 700px;">
                                <p id="tx_info">Busqueda de Documentaci&oacute;n</p>
                                <div id="separador"></div>
                                <section class="bus_doc">
                                ...
                                <section id="tabla">
                                    ...
                                    <?php  while ($filabusq1 = mysqli_fetch_assoc($resbd)) {  ?>
                                    <section id="resultados">
                                        <div id="f_resultados21"><b><?php  echo $filabusq1['numero_oficio']  ?></b>
                                        </div>
                                        <div id="f_resultados2"><?php  echo $filabusq1['fecha_recibido']   ?></div>
                                        <div id="f_resultados2"><?php  echo $filabusq1['fecha_oficio']   ?></div>
                                        <div id="f_resultados2"><?php  echo $filabusq1['fecha_asignacion']   ?></div>
                                        <div id="f_resultados2"><?php  echo $filabusq1['dependencia']   ?></div>
                                        <div id="f_resultados2"><?php  echo $filabusq1['area_dependencia']   ?></div>
                                        <div id="f_resultados2"><?php  echo $filabusq1['asunto']   ?></div>
                                        <div id="f_resultados2"><?php  echo $filabusq1['area_c3']   ?></div>
                                        <div id="f_resultados2"><?php if ($carpeta=$filabusq1['numero_oficio']."_"."solicitud") {
                                            echo documento_solicitud($carpeta,$xPath);
                                        }     ?>
                                        </div>
                                        <div id="f_resultados2">
                                            <?php if ($carpeta=$filabusq1['numero_oficio']."_"."solicitud") { echo documento_respuesta($carpeta,$xPath); } ?>
                                        </div>
                                        <div id="f_resultados2">
                                            <?php if ($carpeta=$filabusq1['numero_oficio']."_"."solicitud") {  echo documento_acuse($carpeta,$xPath,$filabusq1['numero_oficio']); }   ?>
                                        </div>
                                        <div id="f_resultados2">
                                            <?php  imagen_proceso($filabusq1['estatus'],$xPath)    ?></div>
                                    </section><?php   } ?>
                                </section>
                            </section>
                            <?php }  
                                if ($_POST['id_bus']==2) {
                                        $sql_busq = "SELECT * from informacion_sgd where area_dependencia = '$dep' order by fecha_oficio desc";
                                        $resbd = mysqli_query($conexion, $sql_busq); ?>
                            <section style="display: inline-block; width: 100%; max-height: 700px;">
                                <p id="tx_info">Busqueda de Documentaci&oacute;n</p>
                                <div id="separador"></div>
                            ...
                            <?php } if ($_POST['id_bus']==3) {
                                        $sql_busq = "SELECT * from informacion_sgd where asunto = '$dep' order by fecha_oficio desc";
                                        $resbd = mysqli_query($conexion, $sql_busq); ?>
                            <section style="display: inline-block; width: 100%; max-height: 700px;">
                                <p id="tx_info">Busqueda de Documentaci&oacute;n</p>
                                <div id="separador"></div>
                          ...
                          <?php  }  /*if (isset($_POST['b_gmodal2'])) {
                            ...
                            <section id="nuevo_d">
                                ...
                                <div id="cap">
                                    <p id="tx_if">Area:</p><select name="area_depe" id="#area">
                                ...
                                <div id="cap">
                                    <p id="tx_if">Area de Asignacion:</p><select name="area_asig" id="">
                                        <option value="0">--Seleccione--</option>
                                        <?php $sqlasig = "SELECT departamento from depart_sgd";
                                ...
                                <div id="cap">
                                    <p id="tx_if">Encargado del Area Asignada:</p><select name="responsable" id="">
                                        ...
                                        <option value="MAAO740116MMSRLL03">Olga Lidia Martinez Alvarez</option>
                                        <option value="DOMJ860525HGRMRR02">Jorge Dominguez Morales</option>                  
                                        <option value="CUCG830320MVZRRM07">Gemima Cruz Crecencio</option>
                                        <option value="AALA860424MOCPNG01">Maria Agustina Aparicio Leon</option>
                                        <option value="LOLD840701MGRRNN09">Dendera Lorencilla Luna</option>
                                        <option value="SABA811208HGRLLN07">Jose Antonio Salmeron Beltran</option>
                                        <option value="AOFJ801110HGRPGS08">Jesus David Aponte Figueroa</option>
                                        <option value="AARA830829MGRDDR05">Arysai Adame Rodríguez</option>
                                        <option value="ZABV800225HGRMRC03">Victor Hugo Zamora Bernabe</option>
                                        <option value="HEBA870430MGRRZR09">Elida Lopez Araujo</option>
                                    </select>
                                </div>
                                <div id="cap">
                          ...
                          if (isset($_POST['b_guardar'])) { ?>
                            ...
                            <section id="res_all">
                                ...
                                <section id="tabla">
                                    ...
                                    <section id="encabezados">
                                        ...
                                        <div id="e_tabla">Oficio de Respuesta</div>
                                        <div id="e_tabla">Acuse de Oficio</div>
                                    ...
                                    <section id="resultados">
                                        ...
                                        <div id="f_resultados">
                                            <?php if ($carpeta=$filaes['numero_oficio']."_"."solicitud") { echo documento_respuesta($carpeta,$xPath); } ?>
                                        </div>
                                        <div id="f_resultados">
                                            <?php if ($carpeta=$filaes['numero_oficio']."_"."solicitud") {  echo documento_acuse($filaes['numero_oficio']."_"."solicitud",$xPath,$filaes['numero_oficio']); }   ?>
                                        </div>
                            ...
                            <section id="res_all">
                                ...
                                <section id="tabla">
                                    ...
                                    <section id="encabezados">
                                        ...
                                        <div id="e_tabla">Area</div>
                                        <div id="e_tabla">Asunto</div>
                                        <div id="e_tabla">Oficio de Solicitud</div>
                                        <div id="e_tabla">Oficio de Respuesta</div>
                                        <div id="e_tabla">Status</div>

                                    </section>
                                    <?php  while ($filaes2 = mysqli_fetch_assoc($resulespera2)) {  ?>
                                    <section id="resultados">
                                        <div id="f_resultados"><?php  echo $filaes2['numero_oficio']  ?></div>
                                        <div id="f_resultados"><?php  echo $filaes2['fecha_recibido']   ?></div>
                                        <div id="f_resultados"><?php  echo $filaes2['fecha_oficio']   ?></div>
                                        <div id="f_resultados"><?php  echo $filaes2['fecha_asignacion']   ?></div>
                                        <div id="f_resultados"><?php  echo $filaes2['dependencia']   ?></div>
                                        <div id="f_resultados"><?php  echo $filaes2['area_dependencia']   ?></div>
                                        <div id="f_resultados"><?php  echo $filaes2['asunto']   ?></div>
                                        <div id="f_resultados"><?php if ($carpeta=$filaes2['numero_oficio']."_"."solicitud") {
                                            echo documento_solicitud($carpeta,$xPath);
                                        }     ?></div>
                                        <div id="f_resultados"><a id="sub"
                                                href="subir2.php?nom=<?php echo $carpeta ?>&fac=<?php echo $filaes2['numero_oficio'] ?> "><img
                                                    src="<?php echo $xPath;?>imgs/archivo.png" alt="" width="60px"
                                                    style="margin-right: 7px; margin-left: 10px; margin-top: 10px;"></a><br>
                                            <p style="font-family: oswald; font-size: 14px; margin-top: 5px">Subir
                                                Oficio de Respuesta</p>
                                        </div>
                                        <div id="f_resultados"><?php  imagen_proceso($filaes2['estatus'],$xPath)?>
                                        </div>
                                    </section><?php   } ?>
                                </section>
                            </section>
                            ...
                            <section id="res_all">
                                ...
                                <section id="tabla">
                                    ...
                                    <section id="resultados">
                                        <div id="f_resultados21"><b><?php  echo $filatodos['numero_oficio']  ?></b>
                                        </div>
                                        ...
                                        <div id="f_resultados2">
                                            <?php if ($carpeta=$filatodos['numero_oficio']."_"."solicitud") { echo documento_respuesta($carpeta,$xPath); } ?>
                                        </div>
                                        <div id="f_resultados2">
                                            <?php if ($carpeta=$filatodos['numero_oficio']."_"."solicitud") {  echo documento_acuse($carpeta,$xPath,$filatodos['numero_oficio']); }   ?>
                                        </div>
                                        <div id="f_resultados2">
                            ...
                            <section id="res_all">
                                ...
                                <section id="tabla">
                                    ...
                                    <section id="encabezados">
                                        <div id="e_tabla22">Numero de Oficio</div>
                                        <div id="e_tabla22">Fecha Recibido</div>
                                        <div id="e_tabla22">Fecha de Oficio</div>
                                        <div id="e_tabla22">Fecha de Asignacion</div>
                                        <div id="e_tabla22">Dependencia</div>
                                        <div id="e_tabla22">Area</div>
                                        <div id="e_tabla22">Asunto</div>
                                        <div id="e_tabla22">Area de Asignacion</div>
                                        <div id="e_tabla22">Oficio de Solicitud</div>
                                        <div id="e_tabla22">Oficio de Respuesta</div>
                                        <div id="e_tabla22">status</div>
                                    </section>
                                    <?php  while ($filatodos2 = mysqli_fetch_assoc($resultodos2)) {  ?>
                                    <section id="resultados">
                                        <div id="f_resultados22"><b><?php  echo $filatodos2['numero_oficio']  ?></b>
                                        </div>
                                        <div id="f_resultados22"><?php  echo $filatodos2['fecha_recibido']   ?></div>
                                        <div id="f_resultados22"><?php  echo $filatodos2['fecha_oficio']   ?></div>
                                        <div id="f_resultados22"><?php  echo $filatodos2['fecha_asignacion']   ?></div>
                                        <div id="f_resultados22"><?php  echo $filatodos2['dependencia']   ?></div>
                                        <div id="f_resultados22"><?php  echo $filatodos2['area_dependencia']   ?></div>
                                        <div id="f_resultados22"><?php  echo $filatodos2['asunto']   ?></div>
                                        <div id="f_resultados22"><?php  echo $filatodos2['area_c3']   ?></div>
                                        <div id="f_resultados22"><?php if ($carpeta=$filatodos2['numero_oficio']."_"."solicitud") {
                                            echo documento_solicitud($carpeta,$xPath);
                                        }     ?>
                                        </div>
                                        <div id="f_resultados22">
                                            <?php if ($carpeta=$filatodos2['numero_oficio']."_"."solicitud") { echo documento_respuesta($carpeta,$xPath); } ?>
                                        </div>
                                        <div id="f_resultados22">
                                            <?php  imagen_proceso($filatodos2['estatus'],$xPath)    ?></div>
                                    </section><?php   } ?>
                                </section>
                            </section>
                            <?php   } ?>
