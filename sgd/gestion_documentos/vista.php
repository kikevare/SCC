      ...
      */
      ...
      ?>
                ...
                if (isset($_POST['crear2'])) {
                    if (!file_exists('./Archivos/Oficio_respuesta/' . $nom . '/')) {
                        mkdir('./Archivos/Oficio_respuesta/' . $nom . '/', 0777, true);
                ...
                if (isset($_FILES['image2'])) {
                    ...
                    if (empty($errors) == true) {
                        move_uploaded_file($file_tmp, './Archivos/Oficio_respuesta/' . $nom . '/' . $nom.$file_name);
                        echo "<script languaje='JavaScript'>
...
<div id="modal2" class="modalmask">
                        ...
                        <section class="all_content">
                            ...
                            <div >
                                ...
                                <section class="crear">
                                <p id="tx_info">Vista del Documento</p>
                                <div id="separador"></div> 
                                    <embed src="<?php echo $lin;?>" type="application/pdf" width="1000px" height="700px">
                                </section>
                            </div>
                            <?php 
                            if (isset ($_POST['terminar'])) {
                                $sql_up = "UPDATE informacion_sgd set estatus=2 where numero_oficio = '$fac'";
